          ...
          <div className="md:flex md:flex-row-reverse">
            ...
            <div className="md:w-3/5 flex flex-col justify-center">
              <CardHeader className="pt-8 md:pt-12 px-6 md:px-10 pb-6 border-b border-yellow-200">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-yellow-600 mb-1">Vibe Coding Jenius</h2>
...
export default EbookVibeCoding;