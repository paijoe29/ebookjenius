    ...
    <section className="container mx-auto px-4 py-16">
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          ...
          <p className="text-base md:text-xl text-gray-700 mb-10 max-w-lg">
          ...
          <Button className="bg-blue-600 hover:bg-blue-700 text-white text-base px-6 py-3 md:text-lg md:px-8 md:py-5 rounded-md">
            Lihat Koleksi Ebook
          </Button>
        </div>
