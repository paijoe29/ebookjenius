        ...
        <section className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-12">
          <AnimatedSection animationType="from-left" delay={200} className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <Button className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 text-lg px-8 py-6 rounded-md font-semibold">
                Lihat Koleksi Ebook
              </Button>
              <Button className="bg-yellow-500 hover:bg-yellow-600 text-blue-900 text-lg px-8 py-6 rounded-md font-semibold">
                Hubungi Kami
              </Button>
            </div>
          </AnimatedSection>
          <AnimatedSection animationType="from-right" delay={400} className="md:w-1/2 flex justify-center md:justify-end">
            <HeroPricingCard />
          </AnimatedSection>
        </section>
      </div>
          ...
          <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-blue-200 rounded-xl">
            <div className="md:flex">
              <div className="md:w-2/5 bg-blue-50 p-6 md:p-8 flex items-center justify-center">
                <div className="w-full aspect-[3/4] max-w-[280px] bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl shadow-2xl flex flex-col items-center justify-center p-8 text-white text-center">
                  <BookOpen size={80} className="mb-6 opacity-90" />
                  <h3 className="text-3xl font-bold">Prompt Jenius</h3>
                  <p className="text-blue-200 mt-1 text-sm">Kuasai Seni Berbicara dengan AI</p>
                </div>
              </div>
              <div className="md:w-3/5 flex flex-col justify-center">
                <CardHeader className="pt-8 md:pt-12 px-6 md:px-10">
                  <CardTitle className="text-3xl md:text-4xl font-bold text-blue-700">Prompt Jenius</CardTitle>
                  <CardDescription className="text-lg text-gray-600 mt-2">Kuasai Seni Berbicara dengan AI</CardDescription>
                </CardHeader>
                <CardContent className="text-gray-700 leading-relaxed px-6 md:px-10">
                  ...
                  <div className="my-6 text-center md:text-left">
                    <p className="text-gray-500 text-sm">Harga Spesial Ebook</p>
                    <p className="text-4xl font-extrabold text-blue-700 mt-1">Rp 129.000</p>
                  </div>
                </CardContent>
          ...
          <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-yellow-300 rounded-xl">
            <div className="md:flex md:flex-row-reverse">
              <div className="md:w-2/5 bg-yellow-50 p-6 md:p-8 flex items-center justify-center">
                <div className="w-full aspect-[3/4] max-w-[280px] bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl shadow-2xl flex flex-col items-center justify-center p-8 text-gray-900 text-center">
                  <Code size={80} className="mb-6 opacity-90" />
                  <h3 className="text-3xl font-bold">Vibe Coding Jenius</h3>
                  <p className="text-yellow-700 mt-1 text-sm">Temukan Flow State dalam Ngoding</p>
                </div>
              </div>
              <div className="md:w-3/5 flex flex-col justify-center">
                <CardHeader className="pt-8 md:pt-12 px-6 md:px-10">
                  <CardTitle className="text-3xl md:text-4xl font-bold text-yellow-600">Vibe Coding Jenius</CardTitle>
                  <CardDescription className="text-lg text-gray-600 mt-2">Temukan Flow State dalam Ngoding</CardDescription>
                </CardHeader>
                <CardContent className="text-gray-700 leading-relaxed px-6 md:px-10">
                  <p className="mb-6">
                  ...
                  <div className="my-6 text-center md:text-left">
                    <p className="text-gray-500 text-sm">Harga Spesial Ebook</p>
                    <p className="text-4xl font-extrabold text-yellow-600 mt-1">Rp 129.000</p>
                  </div>
                </CardContent>
                <CardFooter className="pb-8 md:pb-12 px-6 md:px-10">
          ...
          <Card className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border-gray-300 rounded-xl">
            <div className="md:flex">
              <div className="md:w-2/5 bg-gray-100 p-6 md:p-8 flex items-center justify-center">
                <div className="w-full aspect-[3/4] max-w-[280px] bg-gradient-to-br from-gray-700 to-gray-900 rounded-xl shadow-2xl flex flex-col items-center justify-center p-8 text-white text-center">
                  <Zap size={80} className="mb-6 opacity-90" />
                  <h3 className="text-3xl font-bold">Digital Marketing Jenius</h3>
                  <p className="text-gray-300 mt-1 text-sm">Dominasi Dunia Online</p>
                </div>
              </div>
              <div className="md:w-3/5 flex flex-col justify-center">
                <CardHeader className="pt-8 md:pt-12 px-6 md:px-10">
                  <CardTitle className="text-3xl md:text-4xl font-bold text-gray-800">Digital Marketing Jenius</CardTitle>
                  <CardDescription className="text-lg text-gray-600 mt-2">Dominasi Dunia Online</CardDescription>
                </CardHeader>
                <CardContent className="text-gray-700 leading-relaxed px-6 md:px-10">
                  <p className="mb-6">
                  ...
                  <div className="my-6 text-center md:text-left">
                    <p className="text-gray-500 text-sm">Harga Spesial Ebook</p>
                    <p className="text-4xl font-extrabold text-gray-800 mt-1">Rp 129.000</p>
                  </div>
                </CardContent>
                <CardFooter className="pb-8 md:pb-12 px-6 md:px-10">
